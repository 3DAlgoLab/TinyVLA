...
class RegistryTest(absltest.TestCase):
    ...
    def setUp(self):
        ...
        self.mocked_method = mock.patch.object(
            registry.Registry, "global_registry", return_value=self.global_registry
        ).start()
    ...
    def test_lookup_function(self):
        ...
        self.assertEqual(registry.Registry.lookup("func1(arg3=9)")(1, 2), (1, 2, 9))
        self.assertEqual(
            registry.Registry.lookup("func1(arg2=9,arg1=99)")(arg3=3), (99, 9, 3)
        )
        self.assertEqual(
            registry.Registry.lookup("func1(arg2=9,arg1=99)")(arg1=1, arg3=3), (1, 9, 3)
        )

        self.assertEqual(registry.Registry.lookup("func1(1)")(1, 2), (1, 1, 2))
        self.assertEqual(
            registry.Registry.lookup("func1(1)")(arg3=3, arg2=2), (1, 2, 3)
        )
        self.assertEqual(registry.Registry.lookup("func1(1, 2)")(3), (1, 2, 3))
        self.assertEqual(registry.Registry.lookup("func1(1, 2)")(arg3=3), (1, 2, 3))
        self.assertEqual(
        ...
        self.assertEqual(registry.Registry.lookup("func1(1, arg3=2)")(3), (1, 3, 2))
