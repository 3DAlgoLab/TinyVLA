...
class DecodeState:
    ...
    def set_uncond_logits_at_current_step(self, logits: jax.Array) -> "DecodeState":
    ...
    def set_rejection_sampling_success_at_current_step(
        ...
        return self._set_row("rejection_sampling_success_per_step", self.step, success)
...
class CFGDensity:
    ...
    def rejection_sample(
        ...
        sample = jnp.where(ok, sample, self.pdf_c.sample(seed=rng_sample))
