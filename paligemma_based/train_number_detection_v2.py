...
from util import prepare_test_dataset, render_example
...
def show_train_samples():
    ...
    for idx, example in zip(range(8), train_data_iterator()):
        ...
        html_out += render_example(
            example["image"], caption, classes=NUM_DETECTION_CLASSES
        )
    ...
    for step in range(1, TRAIN_STEPS + 1):
        ...
        if (step % EVAL_STEPS) == 0:
            ...
            for prefix, image, _, caption in make_predictions(
                ...
                html_out += render_example(
                    image, prefix + caption, classes=NUM_DETECTION_CLASSES
                )
            display(HTML(html_out))
...
if __name__ == "__main__":
    ...
    train_dataset, val_dataset = prepare_test_dataset()
    ...
    TARGET_MODEL_PATH = "./paligemma-3b-pt-224-number_detection.f16.npz"
