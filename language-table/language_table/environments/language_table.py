...
from language_table.environments.utils import utils_pybullet, xarm_sim_robot
from language_table.environments.utils.pose3d import Pose3d
from language_table.environments.utils.utils_pybullet import (
    ObjState,
    XarmState,
    add_visual_sphere,
)
    ...
    def _setup_pybullet_scene(self):
        ...
        if self._debug_visuals:
            self._goal_sphere = add_visual_sphere(
                self._pybullet_client, center=(0, 0, 0), radius=0.02, rgba=(0, 1, 0, 0)
            )
