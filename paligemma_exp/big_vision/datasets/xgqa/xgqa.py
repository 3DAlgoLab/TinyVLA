            ...
            d.update(
                {
                    ...
                    f"train_fs10_{l}": self._generate_examples(
                        "train_10", "few_shot", l
                    ),
                    f"train_fs20_{l}": self._generate_examples(
                        "train_20", "few_shot", l
                    ),
                    f"train_fs25_{l}": self._generate_examples(
                        "train_25", "few_shot", l
                    ),
                    f"train_fs48_{l}": self._generate_examples(
                        "train_48", "few_shot", l
                    ),
                }
            )
    ...
    def _generate_examples(self, split, num_shots, lang):
        ...
        if num_shots == "few_shot":
            file_path = os.path.join(
                _DATA_PATH, "annotations", "few_shot", lang, f"{split}.json"
            )
