...
_CONFIG_TO_IDS_PATH = {
    ...
    (ScicapSubset.LEQ_100_TOKENS, True): "Caption-No-More-Than-100-Tokens/Yes-Subfig",
    (ScicapSubset.LEQ_100_TOKENS, False): "Caption-No-More-Than-100-Tokens/No-Subfig",
}
_SUBFIG_TO_PATH = {True: "SciCap-Yes-Subfig-Img", False: "SciCap-No-Subfig-Img"}
...
class Scicap(tfds.core.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        ScicapConfig(
            ...
            description=("Captions with <= 100 tokens with subfigures" " not allowed."),
            subset=ScicapSubset.LEQ_100_TOKENS,
            subfig=False,
        ),
    ]
            ...
            features=tfds.features.FeaturesDict(
                {
                    ...
                    "caption/lowercase_and_token_and_remove_figure_index": tfds.features.Text(),
                    "caption/normalized/basic_num": tfds.features.Text(),
                    "caption/normalized/advanced_equation_bracket": tfds.features.Text(),
                }
            ),
    ...
    def _generate_examples(self, split: str):
        ...
        for fname in split_images:
            ...
            yield fname, {
                ...
                "caption/lowercase_and_token_and_remove_figure_index": annotations[
                    "1-lowercase-and-token-and-remove-figure-index"
                ]["caption"],
                "caption/normalized/basic_num": annotations["2-normalized"][
                    "2-1-basic-num"
                ]["caption"],
                "caption/normalized/advanced_equation_bracket": annotations[
                    "2-normalized"
