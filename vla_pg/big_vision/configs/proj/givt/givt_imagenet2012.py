...
def get_config(arg=None):
    ...
    if arg.model_size == "large":
        config.vae.model_init = (
            "gs://big_vision/givt/vae_imagenet_2012_beta_1e-5_params"
        )
    else:
        config.vae.model_init = (
            "gs://big_vision/givt/vae_imagenet_2012_beta_5e-5_params"
        )
