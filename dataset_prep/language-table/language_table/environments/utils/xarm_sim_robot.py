...
XARM_WHITE_URDF_PATH = (
    "third_party/bullet/examples/pybullet/gym/"
...
CYLINDER_URDF_PATH = (
    "third_party/py/language_table/environments/assets/suction/" "cylinder.urdf"
)
CYLINDER_REAL_URDF_PATH = (
    "third_party/py/language_table/environments/assets/suction/" "cylinder_real.urdf"
)
