...
def compute_dataset_statistics(
    dataset, num_samples, nested_obs=True, nested_actions=False
):
    ...
    with tqdm.tqdm(
        desc="Computing Dataset Statistics", total=num_samples
    ) as progress_bar:
        observation = None
        action = None
...
def construct_normalizers(
    ...
    if nested_obs:
        obs_norm_layers = tf.nest.pack_sequence_as(observation_spec, obs_norm_layers)
